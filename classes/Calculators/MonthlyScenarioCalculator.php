...
final class MonthlyScenarioCalculator
{
    ...
    private function taxAssumptionsForYear(TaxAssumptions $source, int $year): TaxAssumptions
    {
        return new TaxAssumptions(
            ...
            iabRate: $source->iabRate,
            iabEligibleAcquisitionCost: $source->iabEligibleAcquisitionCost,
            iabEligibleCapitalizableAncillaryCosts: $source->iabEligibleCapitalizableAncillaryCosts,
