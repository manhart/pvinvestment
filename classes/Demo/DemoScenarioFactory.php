...
final class DemoScenarioFactory
{
    ...
    public static function defaultFormValues(): array
    {
        return [
            ...
            'durationYears' => '5',
            'pvCapacityKwp' => '240',
            'pvSpecificYieldKwhPerKwp' => '1000',
            'pvDegradationPercent' => '0',
            'pvAvailabilityPercent' => '100',
            'pvCurtailmentPercent' => '0',
            'electricityPriceCentsPerKwh' => '10',
            'electricityPriceEscalationPercent' => '0',
            'directMarketingCostCentsPerKwh' => '0',
            'otherRevenueDeductionPercent' => '0',
    ...
    private static function scenario(string $id, string $description, BatteryModel $batteryModel): ScenarioInput
    {
        return new ScenarioInput(
            ...
            pvAssumptions: new PvAssumptions(
                ...
                installedCapacityKwp: 240.0,
                specificYieldKwhPerKwp: 1000.0,
                pvAvailabilityRate: 1.0,
